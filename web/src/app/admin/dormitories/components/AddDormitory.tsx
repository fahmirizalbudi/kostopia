...
import { createDormitory } from "@/app/data-access/dormitories"

const AddDormitory = () => {
  const router = useRouter()
  const [isOpen, setIsOpen] = useState<Boolean>(false)
  const [formData, setFormData] = useState<Dormitory>({ name: "", address: "", description: "", price: null, facilities: "", google_maps: "" })
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    const res = await createDormitory({
