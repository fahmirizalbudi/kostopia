...
import AttachProof from "../../transaction/components/AttachProof"
import CashPayment from "../../transaction/components/CashPayment"
...
export default function PaymentMethod() {
  ...
  const { duration } = useDataProvider()
